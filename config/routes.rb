...
Rails.application.routes.draw do
  ...
  match '/resources/auto_complete', :to => 'auto_completes#resources', :via => :get, :as => 'auto_complete_resources'
  ...
  resources :issues do
    ...
    shallow do
      ...
      resources :reservations, :controller => 'reservations', :only => [:index, :show, :create, :destroy]
      resources :resources, :controller => 'resources', :only => [:index, :show, :new, :create, :destroy, :append, :autocomplete_for_resource]
    end
  end
